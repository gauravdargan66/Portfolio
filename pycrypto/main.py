...
def app_nav():
    def clear_all():
        ...
        messagebox.shoinfo('Portfolio Notification','Portfolio Cleared - Add New Coins')
        reset()
    def close_app():
        pycrypto.destroy()
...
def my_portfolio():
    api_request = requests.get("https://pro-api.coinmarketcap.com/v1/cryptocurrency/listings/latest?start=1&limit=300&convert=USD&CMC_PRO_API_KEY=070319d4-d169-437e-8d9a-71d6c0825bdd")
    ...
    for i in range(0,300):
        for coin in coins:
            if api["data"][i]["symbol"] == coin[1]:
                ...
                symbol = Label(pycrypto, text = api["data"][i]["symbol"], bg = "#F3F4F6", fg = "black", font ="Lato 12", borderwidth=2, relief = "groove", padx ="2", pady="2")
                symbol.grid(row = coin_row,column = 2, sticky = N+S+E+W)

                price = Label(pycrypto, text = coin[3] , bg = "#F3F4F6", fg = "black", font ="Lato 12", borderwidth=2, relief = "groove", padx ="2", pady="2")
                price.grid(row = coin_row,column = 3, sticky = N+S+E+W)

                no_coins = Label(pycrypto, text = coin[2], bg = "#F3F4F6", fg = "black", font ="Lato 12", borderwidth=2, relief = "groove", padx ="2", pady="2")
                no_coins.grid(row = coin_row,column = 4, sticky = N+S+E+W)

                prev_price = Label(pycrypto, text = "${0:.2f}".format(api["data"][i]["quote"]["USD"]["price"]), bg = "#F3F4F6", fg = "black", font ="Lato 12", borderwidth=2, relief = "groove", padx ="2", pady="2")
                prev_price.grid(row = coin_row,column = 5, sticky = N+S+E+W)
                ...
                amount_paid.grid(row = coin_row,column = 6, sticky = N+S+E+W)
                ...
                current_val.grid(row = coin_row,column = 7, sticky = N+S+E+W)
                ...
                pl_coin.grid(row = coin_row,column = 8, sticky = N+S+E+W)
                ...
                totalpl.grid(row = coin_row,column = 9, sticky = N+S+E+W)
    ...
    add_coin.grid(row = coin_row + 1,column = 5, sticky = N+S+E+W)
    ...
    update_coin_txt.grid(row = coin_row + 2,column = 5, sticky = N+S+E+W)
    ...
    delete_coin_txt.grid(row = coin_row + 3,column = 5, sticky = N+S+E+W)
    #--------------------------------------------------------------------------
    ...
    totalap.grid(row = coin_row,column = 6, sticky = N+S+E+W)
    ...
    totalcv.grid(row = coin_row,column = 7, sticky = N+S+E+W)
...
def app_header():
    ...
    symbol = Label(pycrypto, text = "Coin Symbol", bg = "#142E54", fg = "white", font="Lato 12 bold", padx = "5", pady = "5", borderwidth=2, relief = "groove")
    symbol.grid(row = 0,column = 2, sticky = N+S+E+W)

    price = Label(pycrypto, text = "Price at which Bought", bg = "#142E54", fg = "white", font="Lato 12 bold", padx = "5", pady = "5", borderwidth=2, relief = "groove")
    ...
    no_coins.grid(row = 0,column = 4, sticky = N+S+E+W)

    prev_price = Label(pycrypto, text = "Current Price", bg = "#142E54", fg = "white", font="Lato 12 bold", padx = "5", pady = "5", borderwidth=2, relief = "groove")
    prev_price.grid(row = 0,column = 5, sticky = N+S+E+W)
    ...
    amount_paid.grid(row = 0,column = 6, sticky = N+S+E+W)
    ...
    totalpl.grid(row = 0,column = 9, sticky = N+S+E+W)
